    ...
    async (input): Promise<GenerateContentOutput> => {
        try {
            ...
            if (rawErrorMessage.includes("API key not valid")) {
                 ...
                 userFriendlyError = 'Content Generation Blocked: This Gemini model requires a project with billing enabled. This is not a bug in the app. To resolve this, please enable billing on your Google Cloud project. If you have free trial credits, they will be used.';

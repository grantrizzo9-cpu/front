...
/**
 * This is the main form component with the two-step logic.
 */
function SignupForm() {
...
/**
 * This wrapper component checks for PayPal configuration and provides the PayPalScriptProvider.
 * It is rendered by the parent page only after the client has mounted.
 */
        ...
        return (
            <Card>
                 <CardHeader>
                    <CardTitle className="font-headline text-2xl">Create Your Account</CardTitle>
                    <CardDescription>
                        Select a plan and create an account to get started.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            The application owner needs to configure the PayPal Client ID. Please add your `NEXT_PUBLIC_PAYPAL_CLIENT_ID` to the `.env` file and **restart the development server**. The signup form cannot be displayed until this is resolved.
                        </AlertDescription>
                    </Alert>
                </CardContent>
                 <CardFooter>

...
const insightsContent: Record<string, any> = {
  ...
  'ai-edge': {
    ...
    content: `
      ...
      <p>SEO requires volume. With AI, you can generate blog intros, product descriptions, and social media posts at a scale that was previously impossible for solo entrepreneurs. This allows you dominate multiple niches simultaneously.</p>
      ...
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <div className="text-center">
            ...
            <Button asChild><Link href="/insights">Back to Insights</Link></Button>
          </div>
        </main>
        <Footer />
      </div>
      ...
      <main className="flex-1 py-12 md:py-20">
        <article className="container max-w-3xl">
          ...
          <div className="mt-20 p-8 rounded-3xl bg-slate-50 border border-slate-100 text-center space-y-6">
            <h2 className="text-3xl font-bold font-headline text-slate-900">Start Your Journey</h2>

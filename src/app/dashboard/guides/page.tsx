...
const allGuides: Guide[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        <li>In your domain registrar's account (from your reseller store), find your new domain and look for a setting called <strong>"Forwarding"</strong>, "Domain Forwarding", or "Redirect". It's often in the DNS settings section.</li>

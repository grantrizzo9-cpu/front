...
const allGuides: Guide[] = [
  ...
  },
  {
    ...
    content: `
        ...
        <p>Your unique affiliate link can be copied from your <a href="/dashboard/settings" class="text-primary font-semibold hover:underline">Settings</a> page. It will follow this format, but using your own username: <a href="[YOUR_AFFILIATE_LINK_HERE]" target="_blank" rel="noopener noreferrer" class="text-primary font-semibold hover:underline">\`<code>https://hostproai.com/?ref=[YOUR_USERNAME_HERE]</code>\`</a>. Always use the exact link from your settings page to ensure proper tracking.</p>

...
export const subscriptionTiers: SubscriptionTier[] = [
  ...
  },
  {
    ...
    description: 'For those building their presence.',
    features: [
      '10 Websites',
      '50 GB NVMe Storage',
      'Basic AI Tools',
  ...
  },
  {
    ...
    description: 'For growing affiliates.',
    features: [
      '25 Websites',
      '100 GB NVMe Storage',
      'Advanced AI Tools',
  ...
  },
  {
    ...
    description: 'For serious affiliates scaling up.',
    features: [
      '75 Websites',
      '250 GB NVMe Storage',
      'Advanced AI Tools',
  ...
  },
  {
    ...
    description: 'For established affiliates and agencies.',
    features: [
      '200 Websites',
      '750 GB NVMe Storage',
      'Pro AI Suite',
  ...
  },
  {
    ...
    description: 'For power-users and large portfolios.',
    features: [
      'Unlimited Websites',
      '2 TB NVMe Storage',
      'Enterprise AI Suite',
